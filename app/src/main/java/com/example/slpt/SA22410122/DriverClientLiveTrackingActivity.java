...
public class DriverClientLiveTrackingActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_client_live_track); // Update with your layout resource
        ...
        cancelTripButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DriverClientLiveTrackingActivity.this, DriverCancelation.class); // Update with your cancellation activity
