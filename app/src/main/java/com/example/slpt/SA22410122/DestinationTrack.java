...
public class DestinationTrack extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.slpt.R.layout.activity_destination_track);

        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(com.example.slpt.R.id.map);
        mapFragment.getMapAsync(this);

        distanceTextView = findViewById(com.example.slpt.R.id.distanceTextView);
