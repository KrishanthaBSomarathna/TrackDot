...
public class Route1TimeTable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_route1_time_table);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                saveToFirebase(); // Call the saveToFirebase method when the button is clicked
                Intent intent=new Intent(Route1TimeTable.this, Route2TimeTable.class);
    ...
    private void saveToFirebase() {
        ...
        for (int i = 0; i < parentLayout.getChildCount(); i++) {
            ...
            if (childView instanceof EditText) {
                ...
                databaseReference.child(FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber().toString()).child("r1timetable").child(sanitizedLocation).setValue(time);
            }
        }
    }
}
